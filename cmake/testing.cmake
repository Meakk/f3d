...
function(f3d_test_long_timeout)
  ...
  add_test(NAME ${ARGV0}
           COMMAND $<TARGET_FILE:f3d>
             ...
             --output ${CMAKE_BINARY_DIR}/Testing/Temporary/${ARGV0}.png
             ${CMAKE_SOURCE_DIR}/data/testing/${ARGV1})
  set_tests_properties(${ARGV0} PROPERTIES TIMEOUT 80)
endfunction()
...
f3d_test(TestGridX suzanne.ply "300,300" "-g --up=+X")
f3d_test(TestGridY suzanne.ply "300,300" "-g --up=+Y")
f3d_test(TestGridZ suzanne.ply "300,300" "-g --up=+Z")
...
f3d_test(TestGLTFSkin SimpleSkin.gltf "300,300")
...
f3d_test(TestCameraConfiguration suzanne.obj "300,300" "--camera-position=0,0,-10 -x --camera-view-up=1,0,0 --camera-focal-point=1,0,0 --camera-view-angle=20 --camera-azimuth-angle=40 --camera-elevation-angle=-80")
...
if(VTK_VERSION VERSION_GREATER_EQUAL 9.0.20210429)
  f3d_test(TestGLTFMorph SimpleMorph.gltf "300,300")
endif()
