...
f3d_test(NAME TestPluginVerbose ARGS --verbose REGEXP "Loading plugin \"native\"" NO_BASELINE LABELS "plugin;native")
...
f3d_test(NAME TestPluginInvalid ARGS --load-plugins=${F3D_SOURCE_DIR}/testing/data/invalid.so REGEXP ${_TEST_PLUGIN_INVALID_REGEXP} NO_BASELINE LABELS "plugin")

if(UNIX AND NOT APPLE)
  f3d_test(NAME TestPluginInvalidSystem ARGS --verbose --load-plugins=invalid REGEXP "file too short" ENV "LD_LIBRARY_PATH=${F3D_SOURCE_DIR}/testing/data:$ENV{LD_LIBRARY_PATH}" NO_BASELINE LABELS "plugin")
endif()
...
if(F3D_PLUGIN_BUILD_DRACO)
  ...
  f3d_test(NAME TestForceReaderGLTFDracoIntoGLTF DATA Box_draco.glb PLUGIN draco ARGS --force-reader=GLTF NO_BASELINE REGEXP "failed to load scene")
endif()

# Test scan plugins
if(NOT F3D_MACOS_BUNDLE)
  f3d_test(NAME TestScanPluginsCheckNative ARGS --scan-plugins NO_RENDER NO_BASELINE REGEXP " - native" LABELS "plugin")

  if(F3D_PLUGIN_BUILD_HDF)
    f3d_test(NAME TestScanPluginsCheckHDF ARGS --scan-plugins NO_RENDER NO_BASELINE REGEXP " - hdf" LABELS "plugin")
  endif()
endif()
